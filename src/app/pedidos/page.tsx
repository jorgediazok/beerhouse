          ...
          {orders.map((order) => (
            <div key={order._id.toString()} className="rounded-2xl bg-white p-7 shadow-sm sm:p-10">
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-dark/10 pb-5">
                ...
                <span className="rounded-full bg-orange/15 px-3.5 py-1.5 text-xs font-semibold text-orange">
                  Confirmado
                </span>
              </div>
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-dark/10 pt-5">
